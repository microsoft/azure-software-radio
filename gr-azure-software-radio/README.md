...
- AZURE_STORAGE_SAS: must contain a SAS token string for the blob storage account specified in 
  AZURE_STORAGE_URL. The SAS token must have full permissions to the storage account.
